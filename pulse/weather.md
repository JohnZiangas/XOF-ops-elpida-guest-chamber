...
**Latest D15** (`562b01cec094`, `2026-07-27T23:46:55.662806+00:00`) — axioms in tension `A4` · verdict `PROCEED` · approval `0.0`. Total broadcasts: `987` (jsonl lines: `1034`).
...
**Recent themes** (most recent first): A0 ← A3 ← A8 ← A0+A1+A10 ← A9
